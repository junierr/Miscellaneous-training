...
data_nowei = data_list1.copy(deep=True)
data_nowei.insert(value=entname, loc=0, column='entname')
data_nowei.to_csv(dspath + "no_score.csv")
data_nowei
...
# 转csv 为加权无pca的数据集，也用于Plan B的起点
data_wei = data_list2.copy(deep=True)
data_wei.insert(value=entname,loc=0,column='entname')
data_wei.to_csv(dspath+"final4_mulwei_nopca.csv")
data_wei
